...
from hhi_dataset import augmentations as hhi_aug
...
def create_dataloader(path, imgsz, batch_size, stride, opt, hyp=None, augment=False, cache=False, pad=0.0, rect=False,
    ...
    # replace the standard one with HHI Json Dataset Format
...
## A wrapper around the standard class that uses the HHI Json Dataset Format
class LoadHHIDataset(LoadImagesAndLabels):  
    def __init__(self, path, img_size=640, batch_size=16, augment=False, hyp=None, rect=False, image_weights=False,
                 cache_images=False, single_cls=False, stride=32, pad=0.0, rank=-1):
        self.img_size = img_size
    ...
    def __getitem__(self, index):
        ...
        if self.augment:
            ...
            hhi_aug.augment_brightness(img, max_chance=0.5, max_range=40)
